...
@section('body')
    ...
    <form action="{{ route('book.update', ['book' => $book->id]) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ @old('description', $book->description) }}">
            @error('description')
            <div id="validationServer03Feedback" class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('total') is-invalid @enderror" id="total" name="total" value="{{ @old('total', $book->total) }}">
            @error('total')
            <div id="validationServer03Feedback" class="invalid-feedback">
                {{ $message }}
            </div>
